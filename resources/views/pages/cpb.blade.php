...
@section('content')
    ...
    <!-- Hero Section -->
    <section class="relative bg-gradient-to-r from-blue-800 to-blue-600 text-white py-20 px-4">
    ...
    <section id="loja-brasilia" class="bg-white py-8">
        <div class="container mx-auto px-4">
            <div class="bg-blue-50 rounded-3xl overflow-hidden shadow-lg border border-blue-100">
                <div class="grid md:grid-cols-2">

                    <!-- Image Side -->
                    <div class="relative h-auto min-h-[500px] bg-gray-200">
                        <img
                    ...
                    <div class="p-8 md:p-12 flex flex-col justify-center">
                        ...
                        <div class="space-y-6 mb-8 text-gray-700">
                            <div class="bg-gray-50 p-4 rounded-xl border border-gray-100">
                                <strong class="block text-gray-900 mb-1">Endereço:</strong>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            <a href="https://livrarias.cpb.com.br/brasilia"
                               target="_blank"
                               rel="noopener noreferrer"
                               class="flex-1 bg-green-600 hover:bg-green-700 text-white text-center py-3 px-6 rounded-lg font-bold transition flex items-center justify-center gap-2">
