...
@section('content')
<img src="{{ asset('img/doutores/doutores_header.webp') }}" alt="Doutores da Esperança" style="width: 100%;">
...
<div class="doutores-container">
    ...
    <div class="identidade-section">
        <h2 style="display: flex; align-items: center; justify-content: center; gap: 15px;">
            <img src="{{ asset('img/doutores/imagem_12.webp') }}" alt="" style="width: 60px; height: 60px; object-fit: contain; border-radius: 8px;">
    ...
    <div class="atividade-section">
        ...
        <div class="atividade-card">
            ...
            <div class="atividade-galeria">
                <img src="{{ asset('img/doutores/imagem_16.webp') }}" alt="Visitas hospitalares">
                <img src="{{ asset('img/doutores/imagem_09.webp') }}" alt="Voluntários em ação">
                <img src="{{ asset('img/doutores/imagem_02.webp') }}" alt="Humanização">
                <img src="{{ asset('img/doutores/imagem_05.webp') }}" alt="Acolhimento">
                <img src="{{ asset('img/doutores/imagem_06.webp') }}" alt="Alegrando pacientes">
                <img src="{{ asset('img/doutores/imagem_10.webp') }}" alt="Equipe de voluntários">
                <img src="{{ asset('img/doutores/imagem_03.webp') }}" alt="Momentos de alegria">
                <img src="{{ asset('img/doutores/imagem_07.webp') }}" alt="Palhaços solidários">
            </div>
        </div>
        ...
        <div class="atividade-card">
            ...
            <div class="atividade-galeria">
                <img src="{{ asset('img/doutores/imagem_14.webp') }}" alt="Oficinas de corações">
                <img src="{{ asset('img/doutores/imagem_13.webp') }}" alt="Artesanato solidário">
                <img src="{{ asset('img/doutores/imagem_04.webp') }}" alt="Voluntários na confecção">
                <img src="{{ asset('img/doutores/imagem_08.webp') }}" alt="Corações de feltro">
                <img src="{{ asset('img/doutores/imagem_18.webp') }}" alt="Amor em cada detalhe">
            </div>
        </div>
        ...
        <div class="atividade-card">
            ...
            <div class="atividade-galeria">
                <img src="{{ asset('img/doutores/imagem_15.webp') }}" alt="Ações em asilos">
            </div>
        </div>
        ...
        <div class="atividade-card">
            ...
            <div class="atividade-galeria">
                <img src="{{ asset('img/doutores/imagem_11.webp') }}" alt="Formação de voluntários">
            </div>
        </div>
